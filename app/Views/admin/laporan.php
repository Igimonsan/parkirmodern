...
<body>
    ...
    <div class="container">
        ...
        <div class="content-card">
            <h2>
                <span>📈 Laporan
                    <?= ucfirst($periode === 'daily' ? 'Harian' : ($periode === 'weekly' ? 'Mingguan' : 'Bulanan')) ?></span>
                ...
                <table>
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php elseif ($periode === 'monthly'): ?>
                                        ...
                                        ?>
                                    <?php else: ?>
                                        <a href="<?= base_url('admin/detail-transaksi/' . $row['tanggal']) ?>"
                                            style="color: #667eea; text-decoration: none; font-weight: 600;">
                                            📅 <?= date('d/m/Y', strtotime($row['tanggal'])) ?>
                                        </a>
                                    <?php endif; ?>
                                </td>
                                <td><strong><?= $row['total_transaksi'] ?></strong> transaksi</td>
                        ...
                        <tr class="summary-row">
                            ...
                            <td><strong>Rp
                                    <?= number_format($totalTransaksi > 0 ? $totalPendapatan / $totalTransaksi : 0, 0, ',', '.') ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
